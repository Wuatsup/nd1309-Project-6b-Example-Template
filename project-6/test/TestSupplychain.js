...
contract('SupplyChain', function(accounts) {
    ...
    it("Testing smart contract function harvestItem() that allows a farmer to harvest coffee", async() => {
        ...
        assert.equal(resultBufferOne[7], originFarmLongitude, 'Error: Missing qor Invalid originFarmLongitude')
    ...
    it("Testing smart contract function fetchItemBufferTwo() that allows anyone to fetch item details from blockchain", async() => {
        ...
        assert.equal(resultBufferTwo[7], retailerID, 'Error: Missing qor Invalid retailerID')
        assert.equal(resultBufferTwo[8], consumerID, 'Error: Missing qor Invalid consumernmerm')
